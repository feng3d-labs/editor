 ...
 */
declare class AnyEmitter<O = any, T = any> {
    /**
 ...
 * 事件
 */
declare const anyEmitter: AnyEmitter<any, any>;
 ...
 * 全局事件发射器。
 */
declare const globalEmitter: EventEmitter<MixinsGlobalEvents>;

/**
 * 只针对Object的事件
 */
declare const objectEmitter: AnyEmitter<any, ObjectEventType>;
/**
 * Object 事件类型
 */
 ...
 * 让T中以及所有键值中的所有键都是可选的
 */
declare type gPartial$1<T> = {
    [P in keyof T]?: gPartial$1<T[P]>;
};
/**
 * 获取T类型中除值为KT类型以外的所有键
 *
 ...
 * ```
 */
declare type NonTypePropertyNames$1<T, KT> = {
 ...
 * ```
 */
declare type NonTypePropertys<T, KT> = Pick<T, NonTypePropertyNames$1<T, KT>>;
/**
 * 选取T类型中值为KT类型的所有键
 *
 * ```
 ...
 * ```
 */
declare type TypePropertyNames<T, KT> = {
    [K in keyof T]: T[K] extends KT ? K : never;
}[keyof T];
/**
 * 选取T类型中值为非函数类型的所有键
 */
declare type PropertyNames$1<T> = NonTypePropertyNames$1<T, Function>;
/**
 * 选取T类型中值为函数的所有键
 *
 * ```
 ...
 * ```
 */
declare type FunctionPropertyNames<T> = TypePropertyNames<T, Function>;
/**
 * 选取T类型中值为KT类型的键
 *
 * ```
 ...
 * ```
 */
declare type TypePropertys<T, KT> = Pick<T, TypePropertyNames<T, KT>>;
declare type Lazy<T> = T | (() => T);
declare type LazyObject<T> = {
...
declare const __class__ = "__class__";
/**
 * 类工具
 */
declare class ClassUtils {
    ...
    getInstanceByDefinition<T>(Cls: Constructor$1<T>): T;
}
/**
 * 类工具
 */
declare const classUtils: ClassUtils;
/**
 * 为一个类定义注册类名
 * @param constructor 类定义
 * @param className 类名
 */
declare function registerClass(constructor: Constructor$1<any>, className?: string): void;
/**
 * 标记objectview对象界面类
 */
declare function decoratorRegisterClass(className?: string): (constructor: Constructor$1<any>) => void;
...
declare class DataTransform {
     ...
     * canvas转换为图片
     */
    canvasToImage(canvas: HTMLCanvasElement, type?: 'png' | 'jpeg', quality?: number): Promise<HTMLImageElement>;
    /**
    ...
    dataURLToArrayBuffer(dataurl: string): Promise<ArrayBuffer>;
    arrayBufferToDataURL(arrayBuffer: ArrayBuffer): Promise<string>;
    ...
    imageToArrayBuffer(img: HTMLImageElement): Promise<ArrayBuffer>;
    imageDataToDataURL(imageData: ImageData, quality?: number): string;
    imageDataToCanvas(imageData: ImageData): HTMLCanvasElement;
    imagedataToImage(imageData: ImageData, quality?: number): Promise<HTMLImageElement>;
    arrayBufferToImage(arrayBuffer: ArrayBuffer): Promise<HTMLImageElement>;
    blobToText(blob: Blob): Promise<string>;
    stringToArrayBuffer(str: string): ArrayBuffer;
    arrayBufferToString(arrayBuffer: ArrayBuffer): Promise<string>;
    /**
     * ArrayBuffer 转换为 对象
     *
     * @param arrayBuffer
     */
    arrayBufferToObject(arrayBuffer: ArrayBuffer): Promise<any>;
 ...
 * @see http://blog.csdn.net/yinwhm12/article/details/73482904
 */
declare const dataTransform: DataTransform;
...
declare class MathUtil implements MixinsMathUtil {
    /**
     * 角度转弧度因子
     */
    DEG2RAD: number;
...
declare class ObjectUtils {
     ...
     */
    static assignDeep<T>(target: T, source: gPartial$1<T>, handlers?: AssignDeepHandler[], deep?: number): T;
    /**
     * 深度比较两个对象子代可枚举属性值
     *
     * @param a 第一个对象
 ...
 */
declare function buildLineGeometry(lineData: {
    /**
 ...
 */
declare class Vector3 implements Vector, Vector3Like {
    __class__: 'Vector3';
    /**
...
interface Quaternion extends MixinsQuaternion {
}
/**
 * 可用于表示旋转的四元数对象
 */
 ...
 * 点与面的相对位置
 */
declare enum PlaneClassification {
    /**
     * 在平面后面
     */
    BACK = 0,
...
declare class Line3 {
     ...
     * @param line3D 直线
     */
    intersectWithLine3D(line3D: Line3): Line3 | Vector3;
    /**
     * 应用矩阵
     * @param mat 矩阵
     */
...
declare class Plane {
     ...
     */
    intersectWithLine3(line: Line3): Line3 | Vector3;
    /**
     * 获取与平面相交直线
     * @param plane3D
     */
 ...
 * 3D射线
 */
declare class Ray3 extends Line3 {
}
...
interface Color3 extends MixinsColor3 {
}
/**
 * 颜色
 */
 ...
 * Vector3 曲线
 */
declare class AnimationCurveVector3 {
    /**
     * X 轴曲线
     */
...
declare class MinMaxCurveVector3 {
    /**
     * x 曲线
     */
    xCurve: MinMaxCurve;
 ...
 *  *
 */
declare class TriangleGeometry {
    /**
     * 从盒子初始化
     * @param box 盒子
     */
 ...
 * 最大最小颜色渐变模式
 */
declare enum MinMaxGradientMode {
    /**
 ...
 * len = 2^(n-1) * n
 */
declare function createGrad(n: number): number[][];
declare function getBits(n: number): number[][];
/**
 * 噪音
 */
...
declare class Path2 extends CurvePath<Vector2> {
...
declare class Shape2 extends Path2 {
    holes: Path2[];
    constructor(points?: Vector2[]);
...
declare class EllipseCurve2 extends Curve<Vector2> {
    aX: number;
    aY: number;
    xRadius: number;
    yRadius: number;
...
declare class ArcCurve2 extends EllipseCurve2 {
...
declare class CubicBezierCurve2 extends Curve<Vector2> {
    v0: Vector2;
    v1: Vector2;
    v2: Vector2;
    v3: Vector2;
...
declare class LineCurve2 extends Curve<Vector2> {
    v1: Vector2;
    v2: Vector2;
...
declare class QuadraticBezierCurve2 extends Curve<Vector2> {
    v0: Vector2;
    v1: Vector2;
    v2: Vector2;
...
declare class SplineCurve2 extends Curve<Vector2> {
    points: Vector2[];
    constructor(points?: Vector2[]);
    getResolution(divisions: number): number;
    getPoint(t: number, optionalTarget: Vector2): Vector2;
...
declare class Index {
    ...
    private _indices;
    constructor(source?: gPartial$1<Index>);
    invalidate(): void;
    /**
     * 渲染数量
     */
...
declare class Shader {
    ...
    constructor(source?: gPartial$1<Shader>);
...
declare type LazyUniforms = LazyObject<Uniforms>;
interface Uniforms extends MixinsUniforms {
}
...
interface RenderAtomic extends MixinsRenderAtomic {
}
/**
 * 渲染原子（该对象会收集一切渲染所需数据以及参数）
 */
declare class RenderAtomic {
    /**
     * 下一个结点
     */
    next: RenderAtomic;
    ...
    constructor(source?: gPartial$1<RenderAtomic>);
...
interface GLCache extends MixinsGLCache {
}
/**
 * GL 缓存
 */
declare class GLCache {
...
declare class Attribute {
     ...
     */
    invalid: boolean;
    constructor(source?: gPartial$1<Attribute>);
    /**
     * 使数据失效
     */
    invalidate(): void;
...
declare const shaderConfig: ShaderConfig;
/**
 * 着色器库，由shader.ts初始化
 */
 ...
 * shader 库
 */
declare const shaderlib: ShaderLib;

declare class ShaderMacroUtils {
    /**
     * 从着色器代码中获取宏变量列表
     * @param vertex
     * @param fragment
 ...
 * 着色器代码宏工具
 */
declare const shaderMacroUtils: ShaderMacroUtils;
...
declare class _IndexedDB {
     ...
     * @param dbname 数据库名称
     */
    getDatabase(dbname: string): Promise<IDBDatabase>;
    /**
     * 打开或者升级数据库
     *
     * @param dbname 数据库名称
     ...
     */
    hasObjectStore(dbname: string, objectStroreName: string): Promise<boolean>;
    /**
     * 获取对象存储名称列表
     *
     * @param dbname 数据库
     */
    getObjectStoreNames(dbname: string): Promise<string[]>;
    /**
     * 创建对象存储
     *
     * @param dbname 数据库名称
     * @param objectStroreName 对象存储名称
     */
    createObjectStore(dbname: string, objectStroreName: string): Promise<void>;
    /**
     * 删除对象存储
     *
     * @param dbname 数据库名称
     * @param objectStroreName 对象存储名称
     */
    deleteObjectStore(dbname: string, objectStroreName: string): Promise<void>;
    /**
     * 获取对象存储中所有键列表
     *
     * @param dbname 数据库名称
     * @param objectStroreName 对象存储名称
     */
    getAllKeys(dbname: string, objectStroreName: string): Promise<string[]>;
    /**
     * 获取对象存储中指定键对应的数据
     *
     * @param dbname 数据库名称
     ...
     * @param key 键
     */
    objectStoreGet(dbname: string, objectStroreName: string, key: string | number): Promise<unknown>;
    /**
     ...
     * @param data 数据
     */
    objectStorePut(dbname: string, objectStroreName: string, key: string | number, data: any): Promise<void>;
    /**
     * 删除对象存储中指定键以及对于数据
     *
     * @param dbname 数据库名称
     ...
     * @param key 键
     */
    objectStoreDelete(dbname: string, objectStroreName: string, key: string | number): Promise<void>;
    /**
     * 清空对象存储中数据
     *
     * @param dbname 数据库名称
     * @param objectStroreName 对象存储名称
     */
    objectStoreClear(dbname: string, objectStroreName: string): Promise<void>;
}
/**
 *
 */
declare const _indexedDB: _IndexedDB;
...
declare class ReadFS {
     ...
     * @param paths 路径
     */
    readStrings(paths: string[]): Promise<string[]>;
    protected _images: {
 ...
 * Http可读文件系统
 */
declare class HttpFS implements IReadFS {
    /**
     * 根路径
     */
    rootPath: string;
...
declare class IndexedDBFS implements IReadWriteFS {
     ...
     * @param data 文件数据
     */
    writeArrayBuffer(path: string, data: ArrayBuffer): Promise<void>;
    /**
     * 写文件
     * @param path 文件路径
     * @param data 文件数据
 ...
 * 索引数据文件系统
 */
declare const indexedDBFS: IndexedDBFS;
 ...
 * 扩展基础可读写文件系统
 */
declare class ReadWriteFS extends ReadFS {
    /**
     * 项目名称（表单名称）
     */
     ...
     * @param arraybuffer 文件数据
     */
    writeFile(path: string, arraybuffer: ArrayBuffer): Promise<void>;
    /**
     * 写ArrayBuffer(新建)文件
     * @param path 文件路径
     * @param arraybuffer 文件数据
     ...
     * 获取指定文件下所有文件路径列表
     */
    getAllPathsInFolder(dirpath?: string): Promise<string[]>;
    /**
     * 移动文件
     * @param src 源路径
     * @param dest 目标路径
     ...
     */
    moveFiles(movelists: [string, string][]): Promise<void>;
    /**
     * 复制一组文件
     * @param copylists 复制列表
     */
    copyFiles(copylists: [string, string][]): Promise<void>;
    /**
     * 删除一组文件
     * @param deletelists 删除列表
     */
    deleteFiles(deletelists: string[]): Promise<void>;
    /**
     * 重命名文件(夹)
     * @param oldPath 老路径
     * @param newPath 新路径
 ...
 * 所有feng3d对象的基类
 */
declare class Feng3dObject<T extends Feng3dObjectEventMap = Feng3dObjectEventMap> extends EventEmitter<T> implements IDisposable {
    /**
     * 名称
     */
    name: string;
     ...
     * @param type
     */
    static getObjects<T extends Feng3dObject>(type?: Constructor$1<T>): T[];
    /**
     * 对象库
     */
 ...
 */
declare type ClipPropertyType = number | Vector3 | Quaternion;
...
declare class AnimationClip extends Feng3dObject {
 ...
 *
 */
declare abstract class LensBase<T extends LensEventMap = LensEventMap> extends Feng3dObject<T> {
    /**
     * 摄像机投影类型
     */
...
interface GeometryTypes extends MixinsGeometryTypes {
}
 ...
 * 几何体
 */
declare class Geometry<T extends GeometryEventMap = GeometryEventMap> extends Feng3dObject<T> {
    private preview;
    name: string;
    /**
     * 资源编号
     ...
     */
    static setDefault<K extends keyof DefaultGeometry>(name: K, geometry: DefaultGeometry[K], param?: gPartial$1<DefaultGeometry[K]>): void;
    /**
     * 获取默认几何体
     *
     * @param name 默认几何体名称
 ...
 * 默认几何体
 */
interface DefaultGeometry extends MixinsDefaultGeometry {
}
...
interface UniformsTypes extends MixinsUniformsTypes {
}
 ...
 * 默认材质
 */
interface DefaultMaterial extends MixinsDefaultMaterial {
}
 ...
 * 射线投射拾取器
 */
declare const raycaster: Raycaster;
/**
 * 拾取的碰撞数据
 */
 ...
 * 可射线捕获
 */
declare class RayCastable extends Behaviour {
 ...
 */
declare class Renderable extends RayCastable {
    get single(): boolean;
    ...
    protected _updateBounds(): void;
    protected _onGetSelfBounds(event: IEvent<{
        bounds: Box3[];
    }>): void;
}
 ...
 * 纹理信息
 */
declare abstract class TextureInfo<T extends Feng3dObjectEventMap> extends Feng3dObject<T> implements Texture {
    /**
     * 纹理类型
     */
    textureType: TextureType;
 ...
 * 2D纹理
 */
declare class Texture2D<T extends Texture2DEventMap = Texture2DEventMap> extends TextureInfo<T> {
    __class__: 'Texture2D';
    /**
     * 纹理类型
     */
 ...
 * 渲染目标纹理
 */
declare class RenderTargetTexture2D extends Texture2D {
    OFFSCREEN_WIDTH: number;
    OFFSCREEN_HEIGHT: number;
    format: TextureFormat;
    minFilter: TextureMinFilter;
 ...
 * 帧缓冲对象
 */
declare class FrameBufferObject {
    OFFSCREEN_WIDTH: number;
    OFFSCREEN_HEIGHT: number;
 ...
 * 灯光
 */
declare class Light extends Behaviour {
    /**
     * 灯光类型
     */
    lightType: LightType;
 ...
 * 立方体纹理
 */
declare class TextureCube<T extends TextureCubeEventMap = TextureCubeEventMap> extends TextureInfo<T> {
    ...
    getTextureImage(pos: TextureCubeImageName): Promise<HTMLImageElement>;
 ...
 * 天空盒组件
 */
declare class SkyBox extends Component {
    __class__: 'SkyBox';
    s_skyboxTexture: TextureCube<TextureCubeEventMap>;
    beforeRender(renderAtomic: RenderAtomic, _scene: Scene, _camera: Camera): void;
}

/**
 * 场景拾取缓存
 */
declare class ScenePickCache {
    private scene;
    private camera;
 ...
 * 3D场景
 */
declare class Scene extends Component {
    __class__: 'Scene';
    /**
     * 背景颜色
     */
 ...
 * 视图
 */
declare class View extends Feng3dObject {
...
declare class Mouse3DManager {
     ...
     * @param _camera 摄像机
     */
    pick(view: View, scene: Scene, _camera: Camera): GameObject;
 ...
 * Window鼠标事件输入
 */
declare class WindowMouseInput extends MouseInput {
    constructor();
    /**
     * 监听鼠标事件收集事件类型
     */
 ...
 * 3d对象脚本
 */
declare class ScriptComponent extends Behaviour {
    runEnvironment: RunEnvironment;
    scriptName: string;
    /**
     * 脚本对象
...
interface GameObjectEventMap extends MixinsGameObjectEventMap, MouseEventMap, Feng3dObjectEventMap {
    /**
     * 添加子组件事件
     */
    addComponent: {
...
interface GameObject extends MixinsGameObject {
}
/**
 * 游戏对象，场景唯一存在的对象类型
 */
declare class GameObject extends Feng3dObject<GameObjectEventMap> implements IDisposable {
     ...
     * @returns 被添加的组件。
     */
    addComponent<T extends Component>(Type: Constructor$1<T>): T;
    /**
     ...
     * @returns 要检索的组件。
     */
    getComponent<T extends Component>(type: Constructor$1<T>): T;
    /**
     ...
     */
    getComponentInChildren<T extends Component>(type: Constructor$1<T>, includeInactive?: boolean): T;
    /**
     ...
     */
    getComponentInParent<T extends Component>(type: Constructor$1<T>, includeInactive?: boolean): T;
    /**
     ...
     */
    getComponents<T extends Component = Component>(type?: Constructor$1<T>, results?: T[]): T[];
    /**
     ...
     * @returns 所有找到的组件。
     */
    getComponentsInChildren<T extends Component>(type?: Constructor$1<T>, includeInactive?: boolean, results?: T[]): T[];
    /**
     ...
     */
    getComponentsInParent<T extends Component>(type?: Constructor$1<T>, includeInactive?: boolean, results?: T[]): T[];
    /**
     * 获取指定位置索引的子组件
     * @param index			位置索引
     * @return				子组件
     ...
     * @param type 组件类型
     */
    removeComponentsByType<T extends Components>(type: Constructor$1<T>): T[];
    /**
     * 判断是否拥有组件
     * @param com	被检测的组件
     ...
     * @param param 游戏对象参数。
     */
    static createPrimitive<K extends keyof PrimitiveGameObject>(type: K, param?: gPartial$1<GameObject>): GameObject;
    /**
 ...
 */
interface PrimitiveGameObject extends MixinsPrimitiveGameObject {
}
 ...
 * 文件夹资源
 */
declare class FolderAsset extends FileAsset {
 ...
 */
declare class AssetData extends Feng3dObject {
    /**
     * 资源名称
     */
     ...
     * @param data 资源数据
     */
    static addAssetData<T>(assetId: string, data: T): T;
    /**
     * 删除资源数据
     *
     * @param data 资源数据
...
declare class ReadRS {
     ...
     */
    createAsset<T extends FileAsset>(Cls: new () => T, fileName?: string, value?: gPartial$1<T>, parent?: FolderAsset): Promise<FileAsset>;
    /**
     * 获取有效子文件名称
     *
     * @param parent 父文件夹
     ...
     * @param id 资源编号
     */
    readAsset(id: string): Promise<FileAsset>;
    /**
     * 读取资源数据
     *
     * @param id 资源编号
     */
    readAssetData(id: string): Promise<any>;
    /**
     * 读取资源数据列表
     *
     * @param assetids 资源编号列表
     */
    readAssetDatas(assetids: string[]): Promise<AssetData[]>;
    /**
     * 获取指定类型资源
     *
     * @param type 资源类型
     */
    getAssetsByType<T extends FileAsset>(type: Constructor$1<T>): T[];
    /**
     * 获取指定类型资源数据
     *
     * @param type 资源类型
     */
    getLoadedAssetDatasByType<T>(type: Constructor$1<T>): T[];
    /**
     * 获取指定编号资源
     *
     * @param id 资源编号
     ...
     */
    deserializeWithAssets(object: any): Promise<unknown>;
}
 ...
 * 可读写资源系统
 */
declare class ReadWriteRS extends ReadRS {
    /**
     * 延迟保存执行函数
     */
     ...
     * @param asset 资源对象
     */
    writeAsset(asset: FileAsset): Promise<void>;
    /**
     * 移动资源到指定文件夹
     *
     * @param asset 被移动资源
     * @param folder 目标文件夹
     */
    moveAsset(asset: FileAsset, folder: FolderAsset): Promise<void>;
    /**
     * 删除资源
     *
     * @param asset 资源
     */
    deleteAsset(asset: FileAsset): Promise<void>;
}
...
declare function getAssetTypeClass<K extends keyof AssetTypeClassMap>(type: K): AssetTypeClassMap[K];
declare function setAssetTypeClass<K extends keyof AssetTypeClassMap>(type: K, cls: AssetTypeClassMap[K]): void;
interface AssetTypeClassMap extends MixinsAssetTypeClassMap {
}
declare const assetTypeClassMap: AssetTypeClassMap;
/**
 * feng3d资源
 */
declare abstract class FileAsset {
    /**
     * 资源路径
     */
    assetPath: string;
     ...
     * 读取资源预览图标
     */
    readPreview(): Promise<HTMLImageElement>;
    /**
     * 读取资源预览图标
     *
     * @param image 预览图
     */
    writePreview(image: HTMLImageElement): Promise<void>;
    /**
     * 删除资源预览图标
     */
     ...
     * 删除文件
     */
    protected deleteFile(): Promise<void>;
    /**
     * 元标签路径
     */
     ...
     * 读取元标签
     */
    protected readMeta(): Promise<void>;
    /**
     * 写元标签
     */
    protected writeMeta(): Promise<void>;
    /**
     * 删除元标签
     */
    protected deleteMeta(): Promise<void>;
    /**
     * 预览图
     */
    private _preview;
...
declare let audioCtx: AudioContext;
declare let globalGain: GainNode;
declare global {
    export interface MixinsComponentMap {
 ...
 * 正射投影镜头
 */
declare class OrthographicLens extends LensBase {
    /**
     * 尺寸
     */
    size: number;
 ...
 * 透视摄像机镜头
 */
declare class PerspectiveLens extends LensBase {
    /**
...
declare class BillboardComponent extends Component {
 ...
 * 参考
 */
declare class CartoonComponent extends Component {
 ...
 */
declare class Graphics extends Component {
    __class__: 'Graphics';
    private image;
    private context2D;
    private canvas;
...
declare function watchContext2D(context2D: CanvasRenderingContext2D, watchFuncs?: string[]): void;
...
declare class HoldSizeComponent extends Component {
...
declare class OutLineComponent extends Component {
 ...
 */
declare class WireframeComponent extends Component {
...
declare class ControllerBase {
     ...
     * 手动应用更新到目标3D对象
     */
    update(_interpolate?: boolean): void;
 ...
 * FPS模式控制器
 */
declare class FPSController extends Behaviour {
    /**
     * 加速度
     */
    acceleration: number;
...
declare class LookAtController extends ControllerBase {
...
declare class HoverController extends LookAtController {
 ...
 * 网格渲染器
 */
declare class MeshRenderer extends Renderable {
 ...
 * 通过修改Transform的数值实现
 */
declare class TransformLayout extends Component {
    get single(): boolean;
    /**
     * 创建一个实体，该类为虚类
     */
     ...
     */
    pivot: Vector3;
    beforeRender(_renderAtomic: RenderAtomic, _scene: Scene, _camera: Camera): void;
...
declare class CustomGeometry extends Geometry {
...
declare const geometryUtils: GeometryUtils;
 ...
 * 线段组件
 */
declare class SegmentGeometry extends Geometry {
...
declare class StandardUniforms {
    __class__: 'StandardUniforms' | 'TerrainUniforms' | 'ParticleUniforms';
    /**
     * 点绘制时点的尺寸
     */
    u_PointSize: number;
 ...
 */
declare function AddComponentMenu(path: string, componentOrder?: number): (target: Constructor$1<Components>) => void;
/**
 * 菜单配置
 */
declare const menuConfig: MenuConfig;
/**
 * 菜单配置
 */
...
declare const createNodeMenu: MenuItem[];
 ...
 * 胶囊体几何体
 */
declare class CapsuleGeometry extends Geometry {
...
declare class CylinderGeometry extends Geometry {
    __class__: 'CylinderGeometry' | 'ConeGeometry';
    /**
     * 顶部半径
     */
    topRadius: number;
 ...
 * 前向渲染器
 */
declare const forwardRenderer: ForwardRenderer;

/**
 * 鼠标拾取渲染器
 */
declare class MouseRenderer extends EventEmitter {
    private objects;
    /**
     * 渲染
     */
    draw(gl: GL, viewRect: Rectangle): GameObject;
    protected drawRenderables(_gl: GL, renderable: Renderable): void;
    /**
     * 绘制3D对象
     */
    protected drawGameObject(_gl: GL, _renderAtomic: RenderAtomic): void;
}
declare const mouseRenderer: MouseRenderer;
 ...
 * 轮廓渲染器
 */
declare const outlineRenderer: OutlineRenderer;
 ...
 * 阴影图渲染器
 */
declare const shadowRenderer: ShadowRenderer;
...
declare class WireframeRenderer {
    private renderAtomic;
    init(): void;
    /**
     * 渲染
 ...
 * 线框渲染器
 */
declare const wireframeRenderer: WireframeRenderer;
...
declare class SceneUtil {
     ...
     * @param _camera 摄像机
     */
    getBlenditems(_scene: Scene, _camera: Camera): void;
    /**
     * 获取需要渲染的对象
     *
     * #### 渲染需求条件
...
declare const sceneUtil: SceneUtil;

/**
 * 天空盒渲染器
 */
declare class SkyBoxRenderer {
    private renderAtomic;
    init(): void;
    /**
     * 绘制场景中天空盒
 ...
 * 天空盒渲染器
 */
declare const skyboxRenderer: SkyBoxRenderer;

declare class CanvasTexture2D extends Texture2D {
    canvas: HTMLCanvasElement;
    constructor();
    private _canvasChanged;
}

declare class ImageDataTexture2D extends Texture2D {
    imageData: ImageData;
    constructor();
 ...
 * 2D纹理
 */
declare class ImageTexture2D extends Texture2D {
    imageSource: HTMLImageElement;
    constructor();
    private _imageChanged;
}

declare class VideoTexture2D extends Texture2D {
...
declare const __functionwrap__ = "__functionwrap__";
declare const functionwrap: FunctionWrap;

/**
 * 图片相关工具
 */
declare class ImageUtil {
    imageData: ImageData;
    /**
     * 获取图片数据
 ...
 */
declare function RegisterComponent(component?: {
    /**
     ...
     */
    dependencies?: Constructor$1<Component>[];
}): (constructor: Constructor$1<Component>) => void;
declare function getComponentType<T extends ComponentNames>(type: T): Constructor$1<ComponentMap[T]>;
/**
 ...
 */
declare class Component extends Feng3dObject<GameObjectEventMap> implements IDisposable {
    /**
     ...
     * @returns GameObject中指定类型的所有组件。
     */
    getComponents<T extends Component>(type: Constructor$1<T>, results?: T[]): T[];
    /**
     * Returns all components of Type type in the GameObject or any of its children children using depth first search. Works recursively.
     *
     * Unity searches for components recursively on child GameObjects. This means that it also includes all the child GameObjects of the target GameObject, and all subsequent child GameObjects.
    ...
    static _componentMap: {
        [name: string]: Constructor$1<Component>;
    };
    /**
     * 获取组件依赖列表
     *
     * @param type 组件类定义
     */
    static getDependencies(type: Constructor$1<Component>): Constructor$1<Component>[];
    /**
     * 判断组件是否为唯一组件。
     *
     * @param type 组件类定义
     */
    static isSingleComponent<T extends Component>(type: Constructor$1<T>): boolean;
}
 ...
 * 二进制 资源
 */
declare class ArrayBufferAsset extends FileAsset {
    /**
     * 文件数据
     */
    arraybuffer: ArrayBuffer;
 ...
 * 音效资源
 */
declare class AudioAsset extends ArrayBufferAsset {
 ...
 * 对象资源
 */
declare abstract class ObjectAsset extends FileAsset {
    /**
     * 资源对象
     */
    data: any;
 ...
 * 游戏对象资源
 */
declare class GameObjectAsset extends ObjectAsset {
    /**
     * 材质
     */
    data: GameObject;
 ...
 * 几何体资源
 */
declare class GeometryAsset extends ObjectAsset {
    static extenson: string;
    /**
     * 几何体
     */
 ...
 * 文本 资源
 */
declare class TextAsset extends FileAsset {
    static extenson: string;
    assetType: AssetType;
    textContent: string;
    initAsset(): void;
 ...
 * JS资源
 */
declare class JSAsset extends TextAsset {
    static extenson: string;
    assetType: AssetType;
    textContent: string;
    initAsset(): void;
 ...
 * JSON 资源
 */
declare class JsonAsset extends TextAsset {
    static extenson: string;
    assetType: AssetType;
    textContent: string;
    initAsset(): void;
 ...
 * 材质资源
 */
declare class MaterialAsset extends ObjectAsset {
    static extenson: string;
    /**
     * 材质
     */
 ...
 * 脚本资源
 */
declare class ScriptAsset extends TextAsset {
    static extenson: string;
    assetType: AssetType;
    /**
     * 脚本父类名称
 ...
 * 着色器 资源
 */
declare class ShaderAsset extends ScriptAsset {
    static extenson: string;
    assetType: AssetType;
}
 ...
 * 纹理文件
 */
declare class TextureAsset extends FileAsset {
 ...
 * 立方体纹理资源
 */
declare class TextureCubeAsset extends ObjectAsset {
    static extenson: string;
    /**
     * 材质
     */
 ...
 * 方程求解
 */
declare const equationSolving: EquationSolving;
...
declare global {
    interface MixinsIObjectView {
    }
    interface MixinsIObjectBlockView {
    }
    interface MixinsIObjectAttributeView {
    }
}
 ...
 * 标记objectview对象界面类
 */
declare function OVComponent(component?: string): (constructor: Constructor<any>) => void;
/**
 * 标记objectview块界面类
 */
declare function OBVComponent(component?: string): (constructor: Constructor<any>) => void;
/**
 * 标记objectview属性界面类
 */
declare function OAVComponent(component?: string): (constructor: Constructor<any>) => void;
/**
 * objectview类装饰器
 */
declare function ov<K extends keyof OVComponentParamMap>(param: {
    component?: K;
    componentParam?: OVComponentParamMap[K];
}): (constructor: Constructor<any>) => void;
declare type OAVComponentParams = Partial<OAVComponentParamMap[keyof OAVComponentParamMap]> & {
    /**
     * 是否可编辑
     */
    editable?: boolean;
 ...
 * @param param 参数
 */
declare function oav(param?: OAVComponentParams): (target: any, propertyKey: string) => void;
/**
 * 对象界面
 */
 ...
 */
interface OAVComponentParamMap extends MixinsOAVComponentParamMap {
 ...
 * 对象属性界面接口
 */
interface IObjectAttributeView extends MixinsIObjectAttributeView {
    /**
     * 界面所属对象（空间）
     */
    space: any;
 ...
 * 对象属性块界面接口
 */
interface IObjectBlockView extends MixinsIObjectBlockView {
    /**
     * 界面所属对象（空间）
     */
    space: any;
 ...
 * 对象界面接口
 */
interface IObjectView extends MixinsIObjectView {
    /**
     * 界面所属对象（空间）
     */
    space: any;
...
declare type GetObjectViewParam = {
    /**
 ...
 * 产生的噪音的质量。
 */
declare enum ParticleSystemNoiseQuality {
    /**
 ...
 */
declare enum ParticleSystemRenderSpace {
    /**
 ...
 */
declare enum ParticleSystemShapeConeEmitFrom {
    /**
     * 从圆锥体底面发射。
     */
    Base = 0,
 ...
 * 发射的形状
 */
declare enum ParticleSystemShapeType1 {
    /**
     * Emit from a sphere.
     *
     * 从球体的体积中发射。
 ...
 */
declare enum ParticleSystemSortMode {
    /**
     * No sorting.
     */
    None = 0,
 ...
 */
declare enum ParticleSystemSubEmitterProperties {
    /**
 ...
 * 导致新粒子产生的事件。
 */
declare enum ParticleSystemSubEmitterType {
    /**
 ...
 * 粒子模块
 */
declare class ParticleModule extends EventEmitter {
    /**
     * 是否开启
     */
    enabled: boolean;
     ...
     * @param _particle 粒子
     */
    initParticleState(_particle: Particle): void;
    /**
     * 更新粒子状态
     * @param _particle 粒子
     */
    updateParticleState(_particle: Particle): void;
    /**
     * 更新
     *
     * @param _interval
 ...
 * 粒子系统 颜色随时间变化模块
 */
declare class ParticleColorOverLifetimeModule extends ParticleModule {
    /**
...
declare class ParticleEmissionBurst {
 ...
 * 粒子系统发射模块。
 */
declare class ParticleEmissionModule extends ParticleModule {
 ...
 */
declare class ParticleForceOverLifetimeModule extends ParticleModule {
    /**
     * 作用在粒子上的力
     */
 ...
 */
declare class ParticleInheritVelocityModule extends ParticleModule {
    '__class__': 'ParticleInheritVelocityModule';
    /**
     * How to apply emitter velocity to particles.
     *
     * 如何将发射体速度应用于粒子。
 ...
 * 基于时间轴限制速度模块。
 */
declare class ParticleLimitVelocityOverLifetimeModule extends ParticleModule {
 ...
 * 粒子主模块
 */
declare class ParticleMainModule extends ParticleModule {
 ...
 */
declare class ParticleNoiseModule extends ParticleModule {
    /**
 ...
 * 粒子系统 旋转角度随速度变化模块
 */
declare class ParticleRotationBySpeedModule extends ParticleModule {
    /**
 ...
 * 粒子系统 旋转角度随时间变化模块
 */
declare class ParticleRotationOverLifetimeModule extends ParticleModule {
    /**
 ...
 * 粒子系统 发射形状
 */
declare class ParticleSystemShape {
     ...
     * @param _dir
     */
    calcParticlePosDir(_particle: Particle, _position: Vector3, _dir: Vector3): void;
}
 ...
 */
declare class ParticleShapeModule extends ParticleModule {
 ...
 * 粒子系统 缩放随速度变化模块
 */
declare class ParticleSizeBySpeedModule extends ParticleModule {
    /**
 ...
 * 粒子系统 缩放随时间变化模块
 */
declare class ParticleSizeOverLifetimeModule extends ParticleModule {
    /**
     * Set the size over lifetime on each axis separately.
     *
     * 在每个轴上分别设置生命周期内的大小。
 ...
 */
declare class ParticleSubEmittersModule extends ParticleModule {
    /**
 ...
 * 粒子系统纹理表动画模块。
 */
declare class ParticleTextureSheetAnimationModule extends ParticleModule {
    /**
 ...
 * 控制每个粒子在其生命周期内的速度。
 */
declare class ParticleVelocityOverLifetimeModule extends ParticleModule {
 ...
 * 粒子系统
 */
declare class ParticleSystem extends Renderable {
 ...
 * 颜色随速度变化模块。
 */
declare class ParticleColorBySpeedModule extends ParticleModule {
    /**
     * The gradient controlling the particle colors.
     *
     * 控制粒子颜色的梯度。
 ...
 */
declare class ParticleSystemRenderer extends ParticleModule {
    /**
 ...
 */
declare class ParticlesAdditiveUniforms {
 ...
 */
declare class ParticlesAlphaBlendedPremultiplyUniforms {
...
declare enum ParticleSystemShapeBoxEmitFrom {
    /**
     * 从盒子内部发射。
     */
    Volume = 0,
 ...
 * 粒子系统 发射盒子
 */
declare class ParticleSystemShapeBox extends ParticleSystemShape {
    /**
     * 盒子X方向缩放。
     */
    get boxX(): number;
 ...
 * 粒子系统 发射圆盘
 */
declare class ParticleSystemShapeCircle extends ParticleSystemShape {
    get radius(): number;
    set radius(v: number);
    get arc(): number;
    set arc(v: number);
 ...
 */
declare class ParticleSystemShapeCone extends ParticleSystemShape {
    /**
     * Angle of the cone.
     * 圆锥的角度。
     */
 ...
 * 粒子系统 发射边
 */
declare class ParticleSystemShapeEdge extends ParticleSystemShape {
    /**
     * 边长的一半。
     */
    get radius(): number;
 ...
 * 从半球体的体积中发出。
 */
declare class ParticleSystemShapeHemisphere extends ParticleSystemShape {
    radius: number;
    /**
     * 是否从球面发射
     */
     ...
     * @param dir
     */
    calcParticlePosDir(_particle: Particle, position: Vector3, dir: Vector3): void;
}

/**
 * 从球体的体积中发射。
 */
declare class ParticleSystemShapeSphere extends ParticleSystemShape {
    /**
     * 球体半径
     */
    get radius(): number;
...
declare class Serialization {
     ...
     */
    serialize<T>(target: T): gPartial$1<T>;
    /**
     ...
     * @returns 反序列化后的数据
     */
    deserialize<T>(object: gPartial$1<T>): T;
    /**
     ...
     */
    different<T>(target: T, source: T): gPartial$1<T>;
    /**
     ...
     */
    setValue<T>(target: T, source: gPartial$1<T>): T;
    /**
     * 克隆
     * @param target 被克隆对象
     */
 ...
 * 默认序列化工具
 */
declare const serialization: Serialization;

/**
 * 代理 EventTarget, 处理js事件中this关键字问题
 */
declare class EventProxy<T = any> extends EventEmitter<T> {
    pageX: number;
    pageY: number;
    clientX: number;
    clientY: number;
 ...
 * 按键状态
 */
declare class KeyState extends EventEmitter {
    /**
 ...
 * 键盘鼠标输入
 */
declare const windowEventProxy: EventProxy<WindowEventMap>;
 ...
 * 地形几何体
 */
declare class TerrainGeometry extends Geometry {
    /**
     * 高度图路径
     */
     ...
     */
    constructor(raw?: gPartial$1<TerrainGeometry>);
 ...
 */
declare class Terrain extends Renderable {
    __class__: 'Terrain';
    /**
     * 地形资源
     */
 ...
 * 地形材质
 */
declare class TerrainMergeMethod extends EventEmitter {
 ...
 * 按钮
 */
declare class Button extends Behaviour {
    /**
     * 按钮所处状态。
     */
    state: ButtonState;
 ...
 * UI几何体
 */
declare class UIGeometry extends Geometry {
 ...
 * 通过修改Transform的数值实现
 */
declare class Transform2D extends Component {
    get single(): boolean;
    transformLayout: TransformLayout;
    /**
     ...
     */
    get layout(): Vector4;
    set layout(v: Vector4);
    private _layout;
    /**
     * 最小锚点，父Transform2D中左上角锚定的规范化位置。
     */
    get anchorMin(): Vector2;
    set anchorMin(v: Vector2);
    private _anchorMin;
    /**
     * 最大锚点，父Transform2D中左上角锚定的规范化位置。
     */
    get anchorMax(): Vector2;
    set anchorMax(v: Vector2);
    private _anchorMax;
    /**
     * The normalized position in this RectTransform that it rotates around.
     */
 ...
 * 用于显示图片
 */
declare class Image extends Component {
    /**
     * The source texture of the Image element.
     *
     * 图像元素的源纹理。
     */
    image: Texture2D<Texture2DEventMap>;
    /**
 ...
 * 画布文本基线
 */
declare enum CanvasTextBaseline {
    'top' = "top",
    'hanging' = "hanging",
    'middle' = "middle",
 ...
 */
declare class TextStyle<T extends TextStyleEventMap = TextStyleEventMap> extends EventEmitter<T> {
    /**
     * @param style 样式参数
     */
 ...
 */
declare function drawText(canvas: HTMLCanvasElement, _text: string, style: TextStyle, resolution?: number): HTMLCanvasElement;
...
declare const __watchs__ = "__watchs__";
declare const __watchchains__ = "__watchchains__";
/**
 * 让T中以及所有键值中的所有键都是可选的
 */
 ...
 * 选取T类型中值为非函数类型的所有键
 */
declare type PropertyNames<T> = NonTypePropertyNames<T, Function>;
/**
 * 获取T类型中除值为KT类型以外的所有键
 *
 * ```
 ...
 * ```
 */
declare type NonTypePropertyNames<T, KT> = {
    [K in keyof T]: T[K] extends KT ? never : K;
}[keyof T];
