import { Vector3, Quaternion, Box3, EventEmitter, Matrix3x3 } from 'feng3d';
...
declare class Transform {
     ...
     */
    toLocalFrameBox3(box3: Box3, target: Box3): Box3;
    /**
     ...
     * @return The "target" AABB object.
     */
    toWorldFrameBox3(box3: Box3, target: Box3): Box3;
...
declare class Shape {
     ...
     */
    calculateLocalInertia(_mass: number, _target: Vector3): void;
    calculateWorldAABB(_pos: Vector3, _quat: Quaternion, _min: Vector3, _max: Vector3): void;
    static idCounter: number;
    /**
...
declare class ConvexPolyhedron extends Shape {
     ...
     */
    getPlaneConstantOfFace(faceI: number): number;
    /**
...
declare class World<T extends WorldEventMap = WorldEventMap> extends EventEmitter<T> {
    static get worldNormal(): Vector3;
    static set worldNormal(v: Vector3);
    /**
...
declare class Body<T extends BodyEventMap = BodyEventMap> extends EventEmitter<T> {
    id: number;
    /**
...
declare class Broadphase {
    ...
    */
     ...
     */
    collisionPairs(_world: World, _p1: Body[], _p2: Body[]): void;
    /**
     ...
     */
    aabbQuery(_world: World, _aabb: Box3, _result: Body[]): any[];
}
...
declare class SAPBroadphase extends Broadphase {
     ...
     * @param p2
     */
    collisionPairs(_world: World, p1: Body[], p2: Body[]): void;
    sortList(): void;
    /**
     ...
     * @param result An array to store resulting bodies in.
     */
    aabbQuery(_world: World, aabb: Box3, result: Body[]): Body<BodyEventMap>[];
}
...
declare class RaycastVehicle {
    ...
    updateSuspension(_deltaTime: number): void;
    /**
     * Remove the vehicle including its constraints from the world.
     *
     * @param world
...
export { Body, BodyEventMap, Box, Broadphase, ConeEquation, ConeTwistConstraint, Constraint, ContactEquation, ContactMaterial, ConvexPolyhedron, Cylinder, DistanceConstraint, Equation, FrictionEquation, GSSolver, GridBroadphase, Heightfield, HingeConstraint, JacobianElement, LockConstraint, Material, NaiveBroadphase, Narrowphase, Octree, OctreeNode, OverlapKeeper, Particle, Plane, PointToPointConstraint, Ray, RaycastResult, RaycastVehicle, RigidVehicle, RotationalEquation, RotationalMotorEquation, SAPBroadphase, SPHSystem, Shape, Solver, Sphere, SplitSolver, Spring, Transform, Trimesh, Utils, WheelInfo, World, WorldEventMap };
export as namespace CANNON;
